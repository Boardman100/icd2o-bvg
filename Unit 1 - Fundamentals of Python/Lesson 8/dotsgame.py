...
box_percentage1 = my_points1/36*100
print()
...
box_percentage2 = my_points2/36*100
print()
...
box_percentage3 = my_points3/36*100
print()
...
box_percentage4 = my_points4/36*100
print()
...
box_percentage5 = my_points5/36*100
print()
...
box_percentage_total = my_points_total/180*100

print(f"{title_opponent:<12}{title_yourpoints:>12}{title_opponentpoints:>19}{title_boxpercent:>9}")
print(f"====================================================")
print(f"{opponent_name1:<12}{my_points1:>12}{opponent_points1:>19}{box_percentage1:>9.2f}")
print(f"{opponent_name2:<12}{my_points2:>12}{opponent_points2:>19}{box_percentage2:>9.2f}")
print(f"{opponent_name3:<12}{my_points3:>12}{opponent_points3:>19}{box_percentage3:>9.2f}")
print(f"{opponent_name4:<12}{my_points4:>12}{opponent_points4:>19}{box_percentage4:>9.2f}")
print(f"{opponent_name5:<12}{my_points5:>12}{opponent_points5:>19}{box_percentage5:>9.2f}")
print(f"====================================================")
print()
...
print(f"Percentage of points recieved: {box_percentage_total:.2f}%")